use artistpath::{Args, dijkstra_find_path};
...
fn test_dijkstra_with_min_match_filter() {
    ...
    let args = Args {
        artist1: "alice".to_string(),
        artist2: "dave".to_string(),
        min_match: 0.75, // Filters out Alice->Bob (0.5) and Charlie->Dave (0.7)
        top_related: 80,
        weighted: true,
        show_similarity: false,
        hide_urls: false,
...
fn test_dijkstra_with_top_related_limit() {
    ...
    let args = Args {
        ...
        artist2: "bob".to_string(),
        min_match: 0.0,
        top_related: 1, // Only take top 1 connection
        weighted: true,
        show_similarity: false,
        hide_urls: false,
        show_ids: false,
